...
import com.ud.demobase.service.IImageMessageService;
...
public class ImageMessageController {
    ...
    @Autowired
    private IImageMessageService imageMessageService;

    @RequestMapping("/imageMessage")
    public String list(Model model) {

        List<ImageMessage> messages = imageMessageService.listAll();
